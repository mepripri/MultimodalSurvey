        ...
        <div className="methodology-content">
          <div className="methodology-row">
            ...
            <p>
              ...
              iterature Search and Selection: We performed an extensive search
              of scientific databases such as Google Scholar, IEEE Xplore, and
              ACM Digital Library, focusing on papers published from 2021
              onwards. We prioritized papers that specifically addressed
          ...
          <div className="methodology-row">
            ...
            <p>
              ...
              lassification of Papers: Each selected paper was classified based
              on the problem domain, solution approach, and methodology. This
              allowed us to identify patterns and trends in the surveyed
          ...
          <div className="methodology-row">
            ...
            <p>
              ...
              axonomy Development: We used classification to develop a
          ...
          <div className="methodology-row">
            ...
            <p>
              ...
              summarizing the main findings, and an interactive taxonomy of the
              surveyed literature. The website was built using state-of-the-art
              web technologies, so a seamless user experience is guaranteed,
              regardless of the device. Visual aids and interactives were added
              to visualize and synthesize the data clearly.
            </p>
          </div>
          <div className="methodology-row">
            <img
